...
/**
 * The namespace's schema: three preferences, each with the default the badge uses
 ...
 * reads the schema, and enforced by `clampSize`/`clampHover` at every point the
 * values are actually used, where a wrong number can only produce a wrong size.
 *
