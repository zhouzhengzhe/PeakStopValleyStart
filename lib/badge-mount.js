...
export function mountBadge(options) {
  ...
  const placeToolbar = (position, size) => {
    ...
    toolbar.style.top = `${Math.min(viewport().height - 40, position.y + size.height + 6)}px`;
  };
