 ...
 *
 * The four edges the table actually emits are `arm`, `peak-start`, `peak-end` and
 * `release`. An earlier version of this map guessed `peak`, so two of the four fell
 * through to the raw English word — and the one that mattered most, "the peak is
 * starting", was one of them.
 */
const EDGE_TEXT = Object.freeze({
  arm: '峰前',
  'peak-start': '峰时',
  'peak-end': '峰后',
  release: '谷时',
