...
export const BADGE_SETTING_FIELDS = Object.freeze(['badgeVisible', 'badgeSize', 'hoverDelayMs']);
 ...
 * @returns {{badgeVisible: boolean, badgeSize: number, hoverDelayMs: number}} the resolved settings.
 */
